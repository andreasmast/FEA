...
%		\vspace{1cm}
	...
	%Problem description
	In this paper a support bracket with a specific load is investigated. For a better understanding of the assignment a schematic representation of the given problem is shown in figure \ref{fig:schema}.
	
	\begin{figure}[h]
		\begin{center}
			\includegraphics[scale=0.5]{Bilder/FEA_schema_3.png}
		\end{center}
